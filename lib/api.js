...
const parseSources = async (sourcePath) => {
  if (!await fs.pathExists(sourcePath)) {
    throw new Error(`A changelog entry is required. Please add changelog notes to at least one file in resources/changelog/, or the directory you've set to convert yml notes to changelog content.`)
  }
